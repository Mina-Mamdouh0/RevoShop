        ...
        Container(
          ...
          child: ListView.separated(
              ...
              itemBuilder: (context, i) {
                return itemList("Kemeja Polos Pria Biru Dongker Navy", "10%", "Rp 888,500",
                    "Rp 999,500", i);
              },
...
class _ModalSheetAddCartState extends State<ModalSheetAddCart> {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style:
                              TextStyle(fontSize: responsiveFont(9), color: secondaryColor),
                        )
                      ],
                    )),
              ),
  ...
  Widget sizeButton(String size, int indexes) {
    return Container(
      decoration: BoxDecoration(
        border: Border.all(color: indexes == index ? Colors.transparent : secondaryColor),
        borderRadius: BorderRadius.circular(5),
