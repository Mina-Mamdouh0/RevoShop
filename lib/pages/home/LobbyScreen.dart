...
class _LobbyScreenState extends State<LobbyScreen> with TickerProviderStateMixin {
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Image.asset('images/popupBg.jpeg'),
              SizedBox(height: 30),
              Text(
                'Today\'s Deal',
              ...
              Text(
                'Get up to 50% off on Organic',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
              ),
              SizedBox(height: 20),
              Text(
                'No tricks, all treats from us this Deal. Get up to 50% off on Organic Products. Sale Started.',
                  ...
                  await Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => BrandProducts(
                                categoryId: dataCategories[1].categories.toString(),
                                brandName: dataCategories[1].titleCategories,
                              )));
                },
                style: ElevatedButton.styleFrom(
                  primary: Colors.white,
  ...
  loadRecentProduct() async {
    await Provider.of<ProductProvider>(context, listen: false).fetchRecentProducts();
  }

  loadHome() async {
    await Provider.of<HomeProvider>(context, listen: false).fetchHomeData(context);
  }
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              home.recommendationProducts.isEmpty
                  ? ''
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: SizedBox(
                          ...
                          child: Marquee(
                            text:
                                '  SALE STARTED NOW! GET UPTO 50% OFF ON HERBAL PRODUCTS.            ',
                            // numberOfRounds: 10,
                          ),
                        ),
                      ),
                            ...
                            child: ListView.separated(
                                ...
                                itemBuilder: (context, i) {
                                  return GestureDetector(
                                      onTap: () {
                                        if (value.productCategories[i].id == clickIndex) {
                                          setState(() {
                                            clickIndex = 0;
                                          ...
                                          setState(() {
                                            clickIndex = value.productCategories[i].id;
                                            selectedCategory =
                                      ...
                                      child: tabCategory(value.productCategories[i], i,
                            ...
                            itemBuilder: (context, i) {
                              return Container(
                                ...
                                child: InkWell(
                                  ...
                                  child: Image.network(value.bannerSpecial[i].image),
                                ),
                              );
                            },
                          ),
                                          ...
                                          onTap: () {
                                            Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) => ProductMoreScreen(
                                                          include: products
                                                              .productSpecial.products,
                                                          name: value
                                                              .specialProducts[0].title,
                                                        )));
                                          },
                                          child: Text(
                                            AppLocalizations.of(context).translate('more'),
                                  ...
                                  : ListView.separated(
                                      ...
                                      itemBuilder: (context, i) {
                                        return CardItem(
                                          ...
                                          i: i,
                                          itemCount:
                                              value.specialProducts[0].products.length,
                                        );
                                      },
                                      separatorBuilder: (BuildContext context, int index) {
                                        return SizedBox(
                            ...
                            return Column(
                              children: [
                                ...
                                AspectRatio(
                                  aspectRatio: 3 / 2,
                                  child: ListView.separated(
                                    itemCount: value.bestProducts[0].products.length,
                                    scrollDirection: Axis.horizontal,
                                    itemBuilder: (context, i) {
                                      return CardItem(
                                        product: value.bestProducts[0].products[i],
                                        i: i,
                                        itemCount: value.bestProducts[0].products.length,
                                      );
                                    },
                                    ...
                                    onTap: () {
                                      if (value.bannerLove[i].product != null) {
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) => ProductDetail(
                                                      productId: value.bannerLove[i].product
                                                          .toString(),
                                                    )));
                                      }
                                    },
                                    child: Image.network(value.bannerLove[i].image)),
                              );
                            },
                          ),
                        );
  ...
  Widget tabCategory(ProductCategoryModel model, int i, int count) {
    return Container(
      margin: EdgeInsets.only(left: i == 0 ? 15 : 0, right: i == count - 1 ? 15 : 0),
      child: Tab(
        child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: clickIndex == model.id ? secondaryColor : HexColor("B0b0b0")),
                  ...
                  child: InkWell(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle:
                            TextStyle(fontSize: responsiveFont(10), color: Colors.black),
                      ),
                    ),
                  )),
              Container(
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                        width: 27.w, child: Image.asset("images/lobby/heart.png")),
                  ),
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                        width: 27.w, child: Image.asset("images/lobby/bellRinging.png")),
                  )
                ],
              ),
            ],
