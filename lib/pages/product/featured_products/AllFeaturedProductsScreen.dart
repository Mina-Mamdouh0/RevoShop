  ...
  Widget build(BuildContext context) {
          ...
          child: GridView.builder(
              ...
              itemBuilder: (context, i) {
                return itemGridList(
                    ...
                    value.listMoreFeaturedProduct[i].discProduct.toInt().toString(),
    ...
    return Scaffold(
      ...
      body: Container(
          ...
          child: Column(
            children: [buildItems, if (product.loadingNew && page != 1) customLoading()],
          )),
    );
  }

  Widget itemGridList(String title, String discount, String price, String crossedPrice,
      int i, int stock, String image, ProductModel productDetail) {
    return Container(
        decoration:
                        ...
                        children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      '$discount%',
                                      style: TextStyle(
                                          color: Colors.white, fontSize: responsiveFont(9)),
                                    ),
                                  ),
                                  Container(
                                    width: 5,
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: stringToCurrency(
                                                double.parse(productDetail.productRegPrice),
                                                context),
                                            style: TextStyle(
                              ...
                              ? RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: stringToCurrency(
                                              double.parse(productDetail.productPrice),
                                              context),
                                          style: TextStyle(
                                      ...
                                      productDetail.variationPrices.isEmpty
                                          ? TextSpan(
                                              ...
                                              style: TextStyle(
                                                  ...
                                                  color: secondaryColor))
                                          : TextSpan(
                                              text: productDetail.variationPrices.first ==
                                                      productDetail.variationPrices.last
                          ...
                          stock != null && stock != 0
                              ...
                              : Text(
                                  "Out of stock",
                                  style: TextStyle(
                                      fontSize: responsiveFont(8), color: changeColor),
                                )
                        ],
                      ),
                    )),
