...
class _ProductDetailState extends State<ProductDetail> with TickerProviderStateMixin {
      ...
      await Provider.of<ProductProvider>(context, listen: false)
        ...
        if (Session.data.getBool('isLogin'))
          await productProvider
              .hitViewProducts(widget.productId)
  ...
  Future<bool> setWishlist(bool isLiked) async {
    if (Session.data.getBool('isLogin')) {
      ...
      final Future<Map<String, dynamic>> setWishlist =
          wishlist.setWishlistProduct(context, productId: productModel.id.toString());
  ...
  Future<dynamic> loadCartCount() async {
    await Provider.of<OrderProvider>(context, listen: false).loadCartCount().then((value) {
      setState(() {
        cartCount = value;
      });
    });
  ...
  Future<bool> loadVariationData() async {
    await ProductAPI()
        .productVariations(
            productId: widget.slug == null ? widget.productId : productModel.id)
        .then((value) {
  ...
  checkFlashSale() {
    ...
    if (flashsale.flashSales != null && flashsale.flashSales.isNotEmpty) {
      setState(() {
        endTime = DateTime.parse(flashsale.flashSales[0].endDate).millisecondsSinceEpoch;
      });
    }
    ...
    return ListenableProvider.value(
      ...
      child: Consumer<ProductProvider>(builder: (context, value, child) {
        ...
        return ColorfulSafeArea(
          color: Colors.white,
          child: Scaffold(
            // floatingActionButton: ContactFAB(), //TODO removed message tab (suresh)
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("${productModel.totalSales} Item Sold",
                                          style:
                          ...
                          child: OutlinedButton(
                              ...
                              onPressed: () {
                                if (productModel.stockStatus != 'outofstock' &&
                                  ...
                                  snackBar(context,
                                      message: "Product currently is out of stock");
                                }
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context).translate('you_might_also'),
                          style: TextStyle(
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => BrandProducts(
                                          categoryId: product.productDetail.categories[0].id
                                              .toString(),
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => AllFeaturedProducts()));
                      },
                      child: Text(
                        AppLocalizations.of(context).translate('more'),
                        style: TextStyle(
          ...
          return Column(
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    "by ",
                    style:
                        TextStyle(color: HexColor("929292"), fontSize: responsiveFont(9)),
                  ),
                  Text(
              ...
              Text(
                ...
                style: TextStyle(
                    color: HexColor("464646"), fontWeight: FontWeight.w400, fontSize: 10),
              ),
            ],
          );
        }),
              ...
              Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: responsiveFont(10), fontWeight: FontWeight.w500),
                  ),
                  Row(
                    children: [
                      Container(
          ...
          return InkWell(
            onTap: () async {
              if (rating != 0 && reviewController.text.isNotEmpty) {
                ...
                snackBar(context, message: 'You must set the rating and review first');
              }
            },
            child: Container(
              width: 80,
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(fontSize: responsiveFont(12), fontWeight: FontWeight.w500),
          ),
          SizedBox(
            height: 10,
          ),
          Text(
            ...
            style: TextStyle(fontSize: responsiveFont(10), fontWeight: FontWeight.w400),
          ),
          SizedBox(
            height: 5,
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                        ...
                        children: <TextSpan>[
                          TextSpan(
                              text: stringToCurrency(
                                  double.parse(productModel.productPrice), context),
                              style: TextStyle(
                                  fontWeight: FontWeight.w600,
                          ...
                          variantPrices.isEmpty
                              ? TextSpan(
                                  ...
                                  style: TextStyle(
                                      ...
                                      color: secondaryColor))
                              : TextSpan(
                                  text: variantPrices.first == variantPrices.last
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: responsiveFont(8), color: Colors.white),
                      ),
                    ],
                  ),
                ),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                          text: stringToCurrency(
                              double.parse(productModel.productRegPrice), context),
                          style: TextStyle(
          ...
          Text(
            model.productName,
            style: TextStyle(fontSize: responsiveFont(15)),
          ),
          SizedBox(
            height: 10,
          ),
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: responsiveFont(11),
                fontWeight: FontWeight.bold,
                color: model.stockStatus == 'instock' ? Colors.green : changeColor),
          ),
          SizedBox(
            height: 10,
          ),
          HtmlWidget(
            ...
            textStyle: TextStyle(color: HexColor("929292"), fontSize: responsiveFont(10)),
          ),
        ],
      ),
    );
  ...
  Widget itemList(String title, String discount, String price, String crossedPrice, int i) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetail()));
      },
      child: Container(
        margin: EdgeInsets.only(left: i == 0 ? 15 : 0, right: i == itemCount - 1 ? 15 : 0),
        decoration:
