              ...
              : Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(AppLocalizations.of(context).translate('comment_empty'))
                    ],
                  ),
                );
        }),
                          ...
                          blogModel.blogImages != null
                              ? Container(
                                  child: CarouselSlider(
                                    ...
                                    items: [
                                      for (var i = 0; i < blogModel.blogImages.length; i++)
                                        AspectRatio(
                                          aspectRatio: 16 / 9,
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Wrap(
                                        children: [
                                          for (var i = 0;
                                              i < blogModel.blogCategories.length;
                                              i++)
                                            Row(
                                              children: [
                                                tag(blogModel
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Visibility(
                                          visible:
                                              Session.data.getBool('isLogin') != null &&
                                                  Session.data.getBool('isLogin'),
                                          child: Container(
                                            margin: EdgeInsets.symmetric(
                                              horizontal: 15,
