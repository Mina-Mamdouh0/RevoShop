      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            accountButton("akun", AppLocalizations.of(context).translate('title_myAccount'),
                func: () {
            ...
            point.loading
                ...
                : Visibility(
                    visible: point.point != null,
                    child: accountButton(
                        "coin", AppLocalizations.of(context).translate('my_point'),
                        func: () {
                      Navigator.push(
                              context, MaterialPageRoute(builder: (context) => MyPoint()))
                          .then((value) => this.setState(() {}));
                    }),
                  ),
            SizedBox(
            ...
            accountButton("myorder", AppLocalizations.of(context).translate('my_order'),
                func: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => MyOrder()));
            }),
            accountButton("wishlist", AppLocalizations.of(context).translate('wishlist'),
                func: () {
            ...
            // }),
            accountButton("logout", AppLocalizations.of(context).translate('logout'),
          ...
          children: [
            ...
            Positioned(
              child: Container(
                ...
                child: Text(
                  Session.data.getString('role').replaceAll('_', ' ').toUpperCase(),
                  style: TextStyle(
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Text(
                              AppLocalizations.of(context).translate('logout_body_alert'),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: responsiveFont(12),
                                  fontWeight: FontWeight.w400),
