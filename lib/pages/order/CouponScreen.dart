...
class _CouponScreenState extends State<CouponScreen> {
  ...
  load() async {
    await Provider.of<CouponProvider>(context, listen: false).fetchCoupon(page: page);
  }
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                          ...
                          child: Text(
                            ...
                            style:
                                TextStyle(fontSize: responsiveFont(8), color: primaryColor),
                          )),
                    )
                  ],
                ),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(stringToCurrency(double.parse(couponModel.amount), context),
                          style:
                              TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                      TextButton(
                        style: TextButton.styleFrom(
                            backgroundColor: _isValid ? primaryColor : Colors.grey,
                            padding: EdgeInsets.symmetric(horizontal: 30)),
                        onPressed: () {
                          if (_isValid) {
                            setState(() {
                              FlutterClipboard.copy(couponModel.code).then((value) =>
                                  snackBar(context,
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                            padding: EdgeInsets.symmetric(horizontal: 15),
                            child: Text(
                              AppLocalizations.of(context).translate('coupon_value'),
                              style: TextStyle(
                          ...
                          Container(
                            padding: EdgeInsets.symmetric(horizontal: 15),
                            child: Text(
                              AppLocalizations.of(context).translate('duration_of_use'),
                              style: TextStyle(
                                  fontSize: responsiveFont(12),
                                  fontWeight: FontWeight.w500),
                            ),
