...
import '../account/AccountEditScreen.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  Widget build(BuildContext context) {
    ...
    var signUp = () async {
      if (controllerFirstname.text.isNotEmpty &&
        ...
        if (controllerphoneNumber.text.isEmpty) {
          return snackBar(context, message: 'Your phone number is not valid');
        }
          ...
          if (checkedValue) {
            ...
            authResponse.then((value) {
              if (value['cookie'] != null) {
                ...
                snackBar(context, message: value['message'], color: changeColor);
              }
              setState(() {
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(fontSize: responsiveFont(14), color: Colors.black),
                ),
                Text(
                  AppLocalizations.of(context).translate('subtitle_create_account'),
                ...
                form(AppLocalizations.of(context).translate('enter_email'), "Email", true,
                    controllerEmail,
                    icon: "email"),
                Container(
                  height: 15,
                ...
                PasswordForm(AppLocalizations.of(context).translate('enter_password'),
                    AppLocalizations.of(context).translate('password'), controllerPassword),
                Container(
                  height: 15,
                ),
                PasswordForm(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context).translate('term_condition_sign_up'),
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => WebViewScreen(
                                      ...
                                      title: generalSettings.privacy.slug.toUpperCase(),
                                    )));
                      },
                ...
                Container(
                  ...
                  child: TextButton(
                    style: TextButton.styleFrom(
                        ...
                        backgroundColor: register.loading ? Colors.grey : secondaryColor),
  ...
  // Widget passwordForm(String hints, String label, TextEditingController controller) {
  //   return Container(
  ...
  //                 child: Image.asset(
  //                     isVisible ? "images/account/melek.png" : "images/account/merem.png")),
  //           ),
  ...
  Widget form(String hints, String label, bool prefix, TextEditingController controller,
      {String icon = "email"}) {
    return Container(
      height: MediaQuery.of(context).size.height / 12,
      child: TextField(
        controller: controller,
        keyboardType: icon == "email" ? TextInputType.emailAddress : TextInputType.text,
        decoration: InputDecoration(
            prefixIcon: prefix
                ? Container(
                    padding: EdgeInsets.only(right: 5),
