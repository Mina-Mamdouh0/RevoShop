...
class _SignInOTPScreenState extends State<SignInOTPScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    signInOTP(String phoneNumber, LoginProvider loginProvider) async {
      ...
      var phone =
          Provider.of<LoginProvider>(context, listen: false).countryCode + phoneNumber;
      ...
      await auth.verifyPhoneNumber(
        ...
        verificationFailed: (e) {
          print(e.message);
          snackBar(context, message: e.message, color: changeColor);
          setState(() {
        ...
        codeSent: (verificationId, [forceResendingToken]) async {
          ...
          final code = await Navigator.push(context,
              MaterialPageRoute(builder: (context) => InputOTP(phone: phoneNumber)));
          if (code != null) {
            print(code);
            ...
            await auth.signInWithCredential(phoneAuthCredential).then((value) async {
              ...
              print('Failed');
              snackBar(context,
                  message: AppLocalizations.of(context).translate('otp_invalid'),
                  color: changeColor);
              setState(() {
                loginProvider.loading = false;
                otpInvalid = true;
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText:
                                  AppLocalizations.of(context).translate('input_otp_hint')),
                        ),
                      ),
                    )
                  ],
