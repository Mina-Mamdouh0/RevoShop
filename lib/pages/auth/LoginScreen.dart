        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context).translate('hint_username')),
                ),
              ),
              Container(
                height: 15,
              ...
              Container(
                ...
                child: TextButton(
                  style: TextButton.styleFrom(
                      ...
                      backgroundColor: auth.loading ? Colors.grey : secondaryColor),
              ...
              if (Platform.isIOS)
                signInButton(
                    "${AppLocalizations.of(context).translate('sign_in')} Apple", "apple"),
            ],
          ),
        ),
      ),
  ...
  Widget signInButton(String title, String image) {
    return InkWell(
      onTap: () {
        if (image == 'message') {
          Navigator.push(
                  context, MaterialPageRoute(builder: (context) => SignInOTPScreen()))
              .then((value) => this.setState(() {}));
      ...
      child: Container(
          ...
          child: Row(
            children: [
              ...
              Text(
                title,
                style: TextStyle(fontSize: responsiveFont(10), color: HexColor("464646")),
              )
            ],
          )),
    );
