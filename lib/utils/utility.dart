...
Color primaryColor = Color(0xfff29429); //HexColor("ED1D1D");
Color secondaryColor = Color(0xfff29429); // HexColor("960000");
Color tertiaryColor = Color(0xfff29429); // HexColor("ED625E");
Color alternateColor = Color(0xfff29429); //HexColor("FD490C");
Color changeColor = Color(0xfff29429);
    ...
    builder: (_) {
      return AlertDialog(
          content: Container(
              ...
              child: Row(
                children: [customLoading(), SizedBox(width: 10), Text("Loading...")],
              )));
    },
